...
{
    public class RC4CryptoServiceProvider : CryptoBase
    {
        /// <summary>
        /// 加密
        /// </summary>
    ...
    public class CryptoBase
    {
        ...
        public byte[] Encrypt(string data, string pass)
        {
            if (data == null || pass == null) return null;
            return EncryptEx(Encode.GetBytes(data), pass);
        }
        ...
        {
            if (data == null || pass == null) return null;
            return Encode.GetString(DecryptEx(data, pass));
        }
